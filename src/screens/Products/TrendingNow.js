        ...
        return (
            <View style={{}}>
                <TouchableOpacity
                    ...
                    <FastImage  source={{ uri: updatedImgUrl }} style={{ borderTopLeftRadius: 8, borderTopRightRadius: 8, width: '90%', alignSelf: "center", marginTop: 5, height: Dimensions.get('window').height / 5 }}
                    />
