            ...
            <View style={{}}>
                <TouchableOpacity onPress={() => navigation.navigate('ViewCatDetails', { catId: item?._id, genderType: item?.genderType })}
                    ...
                    <View style={{ marginTop: 15, marginHorizontal: 10 }}>
                        ...
                        <TouchableOpacity onPress={() => navigation.navigate('ViewCatDetails', { catId: item?._id, genderType: item?.genderType })} style={{ width: "100%", marginHorizontal: 0, borderColor: "#D0433C", borderWidth: 1, borderRadius: 5, alignSelf: "center", alignItems: "center", padding: 5, marginVertical: 10 }}>
